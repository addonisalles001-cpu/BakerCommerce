...
namespace BakerCommerce
{
    ...
    public partial class FormUsuarios : Form
    {
        ...
        private void dgvUsuarios_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtNomeEditar.Text = dgvUsuarios.Rows[ls].Cells[1].Value.ToString();
            txtEmailEditar.Text = dgvUsuarios.Rows[ls].Cells[1].Value.ToString();
        ...
        {
            // Validar campos:
            if (txtNomeEditar.Text.Length < 5)
            {
                MessageBox.Show("O nome deve ter no mínimo 5 caracteres",
                    "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else if (txtEmailEditar.Text.Length < 7) //a@a.com 
            {
